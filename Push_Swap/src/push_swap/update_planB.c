...
/*   Updated: 2026/06/01 16:21:41 by marcooli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_plan	b_plan_rr(t_stack *nodeB)
{
	t_plan	plan;
	int		a;
	int		b;
...
t_plan	b_plan_rrr(t_input *input, t_stack *nodeB)
{
	t_plan	plan;
	int		a;
	int		b;
...
t_plan	b_plan_altern(t_input *input, t_stack *nodeB)
{
	t_plan	plan;
	int		a;
	int		b;
