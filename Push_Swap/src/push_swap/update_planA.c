...
/*   Updated: 2026/06/01 16:19:21 by marcooli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_plan	a_plan_rr(t_stack *stackA)
{
	t_plan	plan;
	int		a;
	int		b;
...
t_plan	a_plan_rrr(t_input *input, t_stack *nodeA)
{
	t_plan	plan;
	int		a;
	int		b;
...
t_plan	a_plan_altern(t_input *input, t_stack *nodeA)
{
	t_plan	plan;
	int		a;
	int		b;
